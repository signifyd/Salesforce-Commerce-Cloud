 ...
 */
 function getParams(order) {
    ...
    var SignifydSCAEnableEvaluation = dw.system.Site.getCurrent().getCustomPreferenceValue('SignifydSCAEnableEvaluation');
    ...
    if (SignifydCreateCasePolicy === "PRE_AUTH") {
        ...
        if (SignifydSCAEnableEvaluation && checkSCAPaymentMethod(order)) {
